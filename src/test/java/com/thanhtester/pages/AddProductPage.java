...
import com.thanhtester.constants.ConfigData;
...
import com.thanhtester.requests.ProductVariant;
...
public class AddProductPage extends CommonPage {
    ...
    public By selectUnitVat = By.xpath("//select[@name='tax_type[]']/following-sibling::button");
...
//        productName = productName + " " + ConfigData.AUTHOR + " " + RandomStringUtils.randomAlphabetic(8).toUpperCase();
        ...
        //vat
        WebUI.scrollToElementToBottom(inputVat);
