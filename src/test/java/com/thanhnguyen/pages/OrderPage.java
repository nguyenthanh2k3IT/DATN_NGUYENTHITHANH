...
import com.thanhnguyen.requests.Address;
import com.thanhnguyen.requests.Cart;
import com.thanhnguyen.requests.OrderAmount;
import com.thanhnguyen.requests.OrderSummary;
...
import static com.thanhnguyen.pages.CartPage.convertCurrencyToBigDecimal;
...
//            WebUI.verifyAssertContain(cartDetails.get(i).getNameProduct(), infoProductsInDisplayPayment.get(i).getNameProduct(), "Ten san pham khong khop so voi gio hang.");
    ...
    public void checkOutOrder(String noteForOrder, String couponCode) {
        ...
        if (currentCart.isEmpty()) {
            ...
            CartPage.addProductToCart("Cosy Thanh OOTVUJLN", "1");
