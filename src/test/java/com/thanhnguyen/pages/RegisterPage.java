...
public class RegisterPage extends CommonPage {
    ...
    public By messageRequiredemail = By.xpath("//strong[normalize-space()='The email field is required.']");
    ...
    public void registerFailWithoutEmail(String fullname, String email, String password, String confirm_password) {
        ...
        WebUI.verifyAssertTrueEqual(messageRequiredemail, "The email field is required.", "Thong bao bat buoc nhap email khong dung.");
        WebUI.sleep(2);
    }
